...
<ProjectCard
  ...
  status="Completed"
  status="Individual, 2022, Collaboration with Lego House, Denmark"
  individual={true}
...
<ProjectCard
  ...
  status="Completed"
  status="Individual, 2022, Collaboration with Pratt Institute, USA"
  individual={true}
...
<ProjectCard
  ...
  status="Individual, 2023, Collaboration with CUCO, the Netherlands"
  className="narrative"
  link="/narrative"
