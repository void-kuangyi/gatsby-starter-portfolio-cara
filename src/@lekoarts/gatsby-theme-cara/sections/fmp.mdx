...
<Text>
  ...
  suggesting that "90% of cultural characteristics, such as non-verbal
  communication or values, are difficult to identify and easy to ignore"
  (Lachner et al., 2015). The deeper audience go down the iceberg, the more
...
<Annotation>
  Participants can pick up a thread that corresponds to their country of origin.
  If they identify as Dutch, they choose the blue thread, otherwise they choose
  the red thread.
</Annotation>
...
<Annotation>
  Upon completion, wearing the special glasses offers a fresh perspective,
  unveiling hidden texts that reveal deeper meanings behind each question.
</Annotation>
<iframe
  width="100%"
  height="500"
  src="https://www.youtube.com/embed/9p7046SwW0s"
...
<Annotation>Exhibit at TU/e graduation demo day</Annotation>
<img src="../../../fmp/interaction5.jpg" />
<img src="../../../fmp/interaction6.jpg" />
<Annotation>The data map after an one-day exhibit</Annotation>
<Title>
